...
func (p ArtifactPlanDeltaProvider) NextPlanDelta(ctx context.Context, input PlanDeltaInput) (PlanDelta, bool, error) {
	...
	for _, ref := range refs {
		...
		if err != nil {
			return PlanDelta{}, false, fmt.Errorf("%w: plan delta artifact %q: %s", agentos.ErrInvalidRunPlan, ref.Name, err)
		}
